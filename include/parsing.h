...
/*   Updated: 2018/11/09 07:25:16 by gmadec      ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
int								ft_attrib_last_redirect(t_op **n_op,
		t_redirect **n_redirect);
int								ft_attrib_last_op(t_seq **b_seq, t_op **ret_op);
int								ft_attrib_last_seq(t_seq **b_seq,
		t_seq **n_seq);
int								ft_attrib_next_redirect(
		t_redirect **n_redirect);
int								ft_attrib_next_op(t_op **n_op);
int								ft_manage_seq(t_seq **b_seq, t_token token);
int								ft_manage_logical_and_pipe(t_seq **b_seq,
		t_token token);
int								ft_manage_redirection(t_seq **b_seq,
		t_token token);
